...
public class cell3 extends basecell3 implements View.OnClickListener {
    public static int score =0;
    public cell3(Context context, int x,int y){
        super(context);
        setPosition(x,y);
    ...
    public void onClick(View v) {
        gameprocessor3.getInstance().click(getXPos(),getYPos());
    }
